...
const ItemDetailOption = ({product,stock}) => {
    ...
    return (
            ...
            :
            <div className="row p-2 bg-light d-flex justify-content-center">
                < Link to={'/'} className="btn btn-warning m-2 w-50 text-uppercase"> Ver Catálogo </Link>
                < Link to={'/carrito'} className="btn btn-warning m-2 w-50 text-uppercase"> Ver Carrito </Link>
                <button onClick={()=>setIsAdd(false)} className="btn btn-warning m-2 w-50 text-uppercase">Ver Tallas</button>
            </div>
    )
}
